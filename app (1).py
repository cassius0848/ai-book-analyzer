...
#  CORTEX UI — 深黑终端风格
# ================================================================
st.set_page_config(page_title="CORTEX // 知识提取", layout="wide", initial_sidebar_state="collapsed")
...
.ctx-header .sys { color: var(--dim); }
.ctx-header .val { color: var(--hi); font-weight: 400; }
...
<div class="ctx-header">
    ...
    <div>
        <span class="sys">MODE</span> <span class="val">知识提取</span>
    </div>
</div>
""", unsafe_allow_html=True)
